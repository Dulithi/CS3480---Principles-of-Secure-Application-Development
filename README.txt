...
Build Instructions:
    First, ensure you have a C compiler installed (e.g., gcc).
    Then, open a terminal and navigate to the directory containing lab1p1.c.
...
Build Instructions:
    First, ensure you have a C compiler installed (e.g., gcc).
    Then, open a terminal and navigate to the directory containing lab1p2.c.
    To compile the program, use the following command in the terminal:
